...
<div class="<?php echo $pluralVar; ?> index">
        <h2><?php echo "<?php echo __('{$pluralHumanName}'); ?>"; ?> <div class="btn-group">
	...
	?>"; ?>
        ...
        <div class="pagination">
                <ul>      
                        <?php
                        echo "<?php\n";
                        echo "\t\techo  '<li>'.\$this->Paginator->prev('<<', array(), null, array('class' => 'prev disabled')).'</li>';\n";
                        echo "\t\techo '<li>'.\$this->Paginator->numbers(array('separator' => '')).'</li>';\n";
                        echo "\t\techo '<li>'.\$this->Paginator->next('>>', array(), null, array('class' => 'next disabled')).'</li>';\n";
                        echo "\t?>\n";
                        ?>
                </ul>        
        </div>
